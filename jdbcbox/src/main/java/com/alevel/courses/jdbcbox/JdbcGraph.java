package com.alevel.courses.jdbcbox;
...
public class JdbcGraph {
    ...
    private static final Logger log = LoggerFactory.getLogger(com.alevel.courses.jdbcbox.JdbcGraph.class);
...
//        resetRoutesAndSolutionsTable(props, url);
    ...
    private static Properties loadProperties() {
        ...
        try (InputStream input = com.alevel.courses.jdbcbox.JdbcGraph.class.getResourceAsStream("/JdbcGraph.properties")) {
            props.load(input);
        } catch (IOException e) {
